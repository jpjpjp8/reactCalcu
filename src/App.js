...
export default function App() {
  ...
  const nameClickHandler = (e) => {
    ...
    // Action to display your name
     setDisp("Jose Paulo Eugenio Mendoza");
  }

  return (
    <div className="App">
      <div className="CalcContainer">
        <h1>Jose Paulo Eugenio Mendoza, CPE-4A </h1>
        ...
        <div className="Name">
          <CalcButton label={"MENDOZA"} onClick={nameClickHandler} buttonClassName={"CalcButtonName"}/>
